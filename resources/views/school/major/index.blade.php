...
@section('content')
    <div>
        <div class="page-heading text-left ">
            <h3 class="mb-3 fs-5">Daftar Jurusan</h3>
            <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#majorCreateModal">Tambah
                data
                +</button>
        </div>
        <div class="row mb-4">
                            ...
                            <tr>
                                ...
                                <td class="align-middle justify-content-center align-items-center d-flex gap-2">
                                    ...
                                    <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                        data-bs-target="#majorEditModal{{ $major->id }}">
        ...
        <div class="modal fade" id="majorCreateModal" tabindex="-1" aria-labelledby="academicCreateModalLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form action="/school/dashboard/major" method="POST">
                            @csrf
                            <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">Nama Jurusan</label>
                                <input type="text" name="name" class="form-control" id="major" required>
                            </div>
                    </div>
        ...
        @foreach ($majors as $major)
            <div class="modal fade" id="majorEditModal{{ $major->id }}" tabindex="-1"
                aria-labelledby="majorEditModalLabel{{ $major->id }}" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <form action="/school/dashboard/major/{{ $major->id }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" id="major"
                                        value="{{ $major->name }}">
                                </div>
        ...
        <script>
            document.addEventListener('DOMContentLoaded', function() {
                ...
                searchInput.addEventListener('input', function() {
                    ...
                    fetch(`{{ route('major.search') }}?query=${encodeURIComponent(query)}`)
