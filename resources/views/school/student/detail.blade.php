                    ...
                    <form class="w-100 mt-4 mb-4">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" id="nama" name="nama" value="{{ $siswa->nama }}" disabled
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select id="agama" name="agama" class="form-select" disabled>
                                        ...
                                        <option value="Islam" {{ $siswa->agama == 'Islam' ? 'selected' : '' }}>Islam
                                        </option>
                                        <option value="Kristen" {{ $siswa->agama == 'Kristen' ? 'selected' : '' }}>Kristen
                                        </option>
                                        <option value="Budha" {{ $siswa->agama == 'Budha' ? 'selected' : '' }}>Budha
                                        </option>
                                        <option value="Hindu" {{ $siswa->agama == 'Hindu' ? 'selected' : '' }}>Hindu
                                        </option>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="email" id="email" name="email"
                                        value="{{ old('email', $siswa->email) }}" class="form-control border" disabled>
                                </div>
