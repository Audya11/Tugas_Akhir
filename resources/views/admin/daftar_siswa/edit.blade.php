                ...
                <div class='container'>
                    <form action="{{ route('siswa.update', $siswa->id) }}" method="POST" enctype="multipart/form-data"
                                ...
                                <select id="sekolah_id" name="sekolah_id" required class="form-select border">
                                    @foreach ($sekolahs as $sekolah)
                                        <option value="{{ $sekolah->id }}"
                                            {{ $sekolah->id == $siswa->sekolah_id ? 'selected' : '' }}>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="email" id="email" name="email"
                                    value="{{ old('email', $siswa->email) }}" required class="form-control border">
                            </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" id="average_score" value="{{ $siswa->average_score }}"
