...
<div class="container-fluid">
    <div class="row">
        ...
        <div class="card my-4 w-75">
            <div class='container'>
                <form action="{{ route('sekolah.update', $sekolah->id) }}" method="POST" enctype="multipart/form-data" class="w-100 mt-4 mb-4">
                    @csrf
                    @method('PUT')
                    <div class="row mb-3">
                        <div class="col-md-6">
                            <label for="paket">Paket</label>
                            <select id="paket" name="paket" required class="form-select w-100">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="radio" id="active" name="status" value="active" {{ $sekolah->status == 'active' ? 'checked' : '' }} required>
                            <label for="active">Aktif</label>
                            <input type="radio" id="inactive" name="status" value="inactive" {{ $sekolah->status == 'inactive' ? 'checked' : '' }}>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <input type="text" id="nama_sekolah" name="nama_sekolah" value="{{ $sekolah->nama_sekolah }}" required class="form-control border">
                        </div>
                        <div class="col-md-6">
                            <label for="tanggal_kadaluarsa">Tanggal Kadaluarsa</label>
                            <input type="date" id="tanggal_kadaluarsa" name="tanggal_kadaluarsa" value="{{ $sekolah->tanggal_kadaluarsa }}" required class="form-control border">
                        </div>
                    </div>
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select id="provinsi" name="provinsi" required class="form-select w-100">
                                <option value="{{ $sekolah->provinsi }}" disabled>{{ $sekolah->provinsi }}</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="kota">Kota</label>
                            <select id="kota" name="kota" required class="form-select w-100">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-6">
                            ...
                            <select id="kecamatan" name="kecamatan" required class="form-select w-100">
                                <option value="{{ $sekolah->kecamatan }}">{{ $sekolah->kecamatan }}</option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <label for="kelurahan">Kelurahan</label>
                            <select id="kelurahan" name="kelurahan" required class="form-select w-100">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="alamat" name="alamat" required class="form-control border">{{ $sekolah->alamat }}</textarea>
                    </div>
